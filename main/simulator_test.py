...
skymod_init_parms = {'name': catlabel, 'frequency': aar.f, 'location': NP.hstack((ra_deg.reshape(-1,1), dec_deg.reshape(-1,1))), 'spec_type': 'func', 'spec_parms': spec_parms, 'src_shape': NP.hstack((majax.reshape(-1,1),minax.reshape(-1,1),NP.zeros(fint.size).reshape(-1,1))), 'src_shape_units': ['degree','degree','degree']}
...
# sky_mod = SM.SkyModel(init_parms=None, init_file='/data3/t_nithyanandan/project_MOFF/simulated/test/skymod1.hdf5')
