...
def main():
    ...
    ops.append(ImagingOp(log, gridandfft_ring, "EPIC_", ntime_gulp=args.nts, cpu=args.cpuonly, accumulation_time=args.accumulate, remove_autocorrs=args.removeautocorrs))
